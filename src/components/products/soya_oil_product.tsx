...
export default function SoyaOilProductDetail() {
        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 xl:gap-16 items-start lg:items-start">
          ...
          <div className="">
            ...
            <p className="text-[#2C2C2C] text-sm sm:text-base lg:text-base leading-relaxed mb-8 sm:mb-10 lg:mb-12">
              High-quality crude organic soya bean oil. Mechanically extracted and expelled, 
              rich in Omega-3 fatty acids. Cold-pressed and solvent-free soya oil that 
              retains its natural nutrients and flavour, making it ideal for healthy cooking 
