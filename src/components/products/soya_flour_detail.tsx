...
export default function SoyaFlourProductDetail() {
  ...
  const benefits = [
    "Rich in tocopherol, lecithin and isoflavones",
    "Ideal for baking and food blending",
    "Gluten-free"
  ];
        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 xl:gap-16 items-start lg:items-start">
          ...
          <div className="">
            ...
            <p className="text-[#2C2C2C] text-sm sm:text-base lg:text-base leading-relaxed mb-8 sm:mb-10 lg:mb-12">
                Defatted and finely milled soya beans, rich in protein and low in fat. 
                Our finely milled soya flour is rich in protein, tocopherol, lecithin, 
                isoflavones, and gluten-free. It enhances the nutrition profile of 
                baked goods and other formulations.
            </p>
